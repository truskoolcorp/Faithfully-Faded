export const PRODUCTS = [
  {
    ...
    featuredImage: '/images/products/hooded-baseball-jersey-dress.png',
  ...
  },
  {
    ...
    badge: null,
    emoji: '👕',
    image: '/images/products/signature-crop-hoodie.webp',
    ...
    details: ['450gsm heavyweight French terry', 'Cropped boxy fit', 'Dropped shoulder seams', 'Raw-cut hem finish', 'Kangaroo pocket', 'Embroidered butterfly chest logo'],
    colors: [
      { name: 'Maroon', hex: '#420420' },
  ...
  },
  {
    ...
    badge: null,
    emoji: '👖',
    image: '/images/products/culture-joggers.webp',
